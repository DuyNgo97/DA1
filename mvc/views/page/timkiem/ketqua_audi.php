<?php 
    if(isset($data['click_audi'])){ 
        $arrAD = json_decode($data['click_audi']);
        // var_dump($arrAD);
    }
?>
<div class="row">
    <?php              
        if(is_array($arrAD) || is_object($arrAD)){       
            foreach($arrAD as $key => $ad){ ?>
    <!-- item -->
    ...
    <div class="product-item card-pd col-6 col-md-6 col-lg-4 text-center">
        <div class="item-info mb-3 p-2 border-s position-relative">
            ...
            <div class="img-thumbnail">
                <img class="mw-100" height="" src="public/images/<?= $ad[16] ?>" alt="">
            </div>
            <div class="mb-2 mt-2">
                <div class="product-name">
                    <a class="fs-5" href="spct/sayhi/<?= $ad[0] ?>" target="_self">
                        <?= $ad[1] ?>
                    </a>
                </div>
            ...
            <div class="product-btn d-flex justify-content-around">
                ...
                <a class="btn view fs-4" href="spct/sayhi/<?= $ad[0] ?>" target="_self">
