<?php 
    if(isset($data['click_1t'])){ 
        $arr1T = json_decode($data['click_1t']);
        // var_dump($arr1T);
    }
?>
<div class="row">
    <?php              
        if(is_array($arr1T) || is_object($arr1T)){       
            foreach($arr1T as $key => $ty){ ?>
    <!-- item -->
    ...
    <div class="product-item card-pd col-6 col-md-6 col-lg-4 text-center">
        <div class="item-info mb-3 p-2 border-s position-relative">
            ...
            <div class="img-thumbnail">
                <img class="mw-100" height="" src="public/images/<?= $ty[16] ?>" alt="">
            </div>
            <div class="mb-2 mt-2">
                <div class="product-name">
                    <a class="fs-5" href="spct/sayhi/<?= $ty[0] ?>" target="_self">
                        <?= $ty[1] ?>
                    </a>
                </div>
            ...
            <div class="product-btn d-flex justify-content-around">
                ...
                <a class="btn view fs-4" href="spct/sayhi/<?= $ty[0] ?>" target="_self">
