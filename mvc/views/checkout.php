...
if (!in_array($_SESSION['vaitro'], $arrPQ)) {
    echo '
		...
		window.location = "http://localhost/da1bk/cart";
		</script>
	';
}
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td><?= $ca['name'] ?></td>
                                        <td><?= $ca['quantity'] ?></td>
                                        <td><?= number_format(($ca['quantity'] * $ca['price'] * (1 - $ca['giamgia'])))  ?>
                                            VND</td>
                                    </tr>
                                <?php }
                                ?>
                                ...
                                <tr>
                                    ...
                                    <td><?= number_format($data['totalall']) ?> VND</td>
                ...
                <div class="col-md-7 order-md-1">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" id="firstName" placeholder="" value="<?= $_SESSION['nameUS'] ?>" required>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="username" name="sdt" placeholder="Nhập số điện thoại" value="<?= $_SESSION['user'][0][5] ?>" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" name="email" value="<?= $_SESSION['user'][0][3] ?>" id="email" placeholder="...@email.com">
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="diachi" value="<?= $_SESSION['user'][0][4] ?>" id="address" placeholder="VD: 123 Trường Chinh" required>
                        <div class="invalid-feedback">
                    ...
                    <hr class="mb-4">
                    <button class="btn btn-primary btn-lg btn-block" type="submit" style="background-color:#198754 ;">Thanh
                        toán</button>
                    <!-- </form> -->
                </div>
            </div>
